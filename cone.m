...
%          h    : height of cone       
% outputs: outputs which can be plotted by: 
% mesh(X3+vertex(1),Y3+vertex(2),Z3+vertex(3));
% where vertex = [x0,y0,z0] represents the vertex of the cone.

function [X3,Y3,Z3] = cone(theta,d,h)
%    theta = 45;
